      ...
      <div className="container">
        <SectionBorder>
          <SectionContent className="!pt-0">
            <h2 className="text-center text-1xl font-bold uppercase tracking-widest test-gray-500 ">
              <span className="ml-2 text-emerald-300"> وكالة الاصيل </span>
              شريكك نحو التميز والإبداع الرقمي
            </h2>
