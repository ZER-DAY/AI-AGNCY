...
import tawfigimg from "@/assets//images/tawfigimg.jpg";
...
export const testimonials = [
  {
    quote:
      "لقد أحدثت ASILAI ثورة حقيقية في طريقة تعاوننا. فبفضل قدرات روبوت الدردشة الذكي في أتمتة المهام وتقديم التوصيات القيمة، تمكنا من توفير ساعات ثمينة كل أسبوع. أصبح الآن جزءًا أساسيًا في سير عملنا .",
    name: "توفيق الجليس",
    title: "مؤسس المنصة",
    image: tawfigimg,
  },
...
export const Testimonials = () => {
  ...
  return (
    <section dir="rtl" id="testimonials">
