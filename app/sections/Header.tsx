...
import logoImage from "@/assets/images/Logoasel.png";

export const navItems = [
  { name: "الميزات", href: "#features" },
  { name: " خدماتنا الذكية", href: "#pricing" },
  { name: "من نحن", href: "#testimonials" },
];
...
export const loginItems = [
  {
    ...
    name: "أنظم معنا",
    href: "https://www.tiktok.com/t/ZMk2qejb2/",
  },
] satisfies {
        ...
        <div className="container">
          <div className="h-18 lg:h-20 flex justify-between items-center">
            ...
            <div className="flex gap-4 items-center">
              ...
              <div className=" pt-3 font-extrabold text-2xl text-amber-400	">
                وكالة الأصيل
              </div>
            </div>
              ...
              <nav className="h-full">
                {navItems.map(({ name, href }) => (
                  <a
                    href={href}
                    key={href}
                    className="h-full px-10 relative font-bold text-xs tracking-widest text-amber-400 uppercase inline-flex items-center
