...
export const features = [
  "البحث في الفيديوهات الرائجة",
  "المساعدة على كتابة النصوص ",
  "المساعدة على إنشاء فيديو قصير",
];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
              <div>
                <h2 className="text-3xl md:text-4xl lg:text-5xl  font-semibold text-gray-200 leading-tight ">
                  ابتكر فيديوهاتك بالذكاء الاصطناعي
                </h2>
                ...
                <Button className="mt-16">أنظم الان</Button>
              </div>
